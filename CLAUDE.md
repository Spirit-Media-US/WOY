...
during Phase 2H of the execute plan. Substitute WOY with the actual R2 path slug.
...
- **URL pattern**: `https://assets.spiritmediapublishing.com/WOY/hero-*.webp` (plus any other LCP images moved to R2 per this site's hero structure)
